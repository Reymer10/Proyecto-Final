...
public class proveedores extends javax.swing.JFrame {
    ...
    private void buscar(int id) throws SQLException {
        ...
        ResultSet rs = ps.executeQuery("SELECT * FROM proveedores WHERE id = " + id);
    ...
    private void updateTextsValues() throws SQLException {
        ...
        PreparedStatement ps = cn.prepareStatement("SELECT * FROM proveedores WHERE id = ?");
        ps.setInt(1, id);
    ...
    private static void update(int id, String nombre, String telefono, String direccion, String correo) throws SQLException {
        Conexion cc = new Conexion();
        Connection cn = cc.connect();
        PreparedStatement ps = cn.prepareStatement("UPDATE proveedores SET nombre = ?, telefono = ?, direccion = ?, correo = ? WHERE id = ?");
        ps.setInt(5, id);
    ...
    private void loadTable() throws SQLException {
        ...
        Statement ps = cn.createStatement();
        ResultSet rs = ps.executeQuery("SELECT * FROM proveedores");
